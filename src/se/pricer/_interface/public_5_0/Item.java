 ...
 *         &lt;element name="itemProperties" type="{http://public_5_0.interface.pricer.se/}PropertyValue" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class Item {
    ...
    protected List<PropertyValue> itemProperties;
     ...
     * 
     */
    public List<PropertyValue> getItemProperties() {
        if (itemProperties == null) {
            itemProperties = new ArrayList<PropertyValue>();
        }
